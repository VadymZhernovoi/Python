...
class DBConnector:
        ...
        try:
            with self.get_connection() as connection:
                with connection.cursor() as cursor:
                    ...
                    if result[0] == 1:
                        print(f" Die Verbindung zur MySQL-Datenbank: '{database}' wurde erfolgreich hergestellt.")
            # MongoDB connection
            ...
            print(f" Die Verbindung zur MongoDB-Datenbank: '{self.mongo_base}' wurde erfolgreich hergestellt.")

        except errors.ConnectionFailure:
            # print(" Ошибка подключения к MongoDB")
            print(" Fehler beim Herstellen einer Verbindung zu MongoDB")
            raise
        except errors.OperationFailure:
            print(" Autorisierungs- oder Anforderungsfehler")
            raise
        except pymysql.err.OperationalError as e:
            print(f" Fehler beim Herstellen einer Verbindung zu MySQL: {e}")
    ...
    def check_connection(self) -> Any:
        ...
        print(" Willkommen! Alle Verbindungen zu den Datenbanken wurden überprüft, guten \"Flug\"!")
